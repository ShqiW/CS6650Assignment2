...
/**
 * SQS认证配置类 - 提供不使用IAM的SQS连接方式
 */
public class SQSAuthConfig {

    // 配置项
    private static final String SQS_QUEUE_URL = System.getProperty("aws.queueUrl",
            "https://sqs.us-west-2.amazonaws.com/145832436892/ski-lift-events");
    private static final String AWS_REGION = System.getProperty("aws.region", "us-west-2");
    ...
    public static AmazonSQS getSQSClient() {
        ...
        switch(authMethod) {
            ...
            case "sts":
                ...
                return createSQSClientWithSTS(roleArn, "SkiResortSession");
            case "ec2":
